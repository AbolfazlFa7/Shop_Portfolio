...
urlpatterns = [
    ...
    # OTP
    path(
        "otp/send/activate_account/",
        views.SendOTPActivateAccountApiView.as_view(),
        name="send_otp_activate_account",
    ),
    path(
        "otp/verify/activate_account/",
        views.VerifyOTPActivateAccountApiView.as_view(),
        name="verify_otp_activate_account",
    ),
    path(
        "otp/send/reset_password/",
        views.SendOTPPasswordResetView.as_view(),
        name="send_otp_reset_password",
    ),
    path(
        "otp/verify/reset_password/",
        views.VerifyOTPPasswordResetView.as_view(),
        name="verify_otp_reset_password",
    ),
    path(
        "otp/send/phone_set/",
        views.SendOTPPhoneSetApiView.as_view(),
        name="send_otp_phone_set",
    ),
    path(
        "otp/verify/phone_set/",
        views.VerifyOTPPhoneSetApiView.as_view(),
